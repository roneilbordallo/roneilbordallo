...
**`Cyber Security Researcher, Hacker, Developer`**
...
Hello, I’m Roneil, a **Cybersecurity Researcher**, **Hacker**, and **Developer** focused on discovering vulnerabilities, hunting bugs, and building tools that improve security. I’m driven by continuous learning and the pursuit of stronger, safer systems across the web.

🚀 I contribute to security by:
- Participating in **Bug Bounty Programs**
- Reporting vulnerabilities to private and public VDPs
- Exploring Web Security, Application Security, and Cloud attack surfaces

💻 I also develop:
- Web apps, mobile apps, and software tools
- Open-source projects for hacking, automation, and security research

🔒 Proudly affiliated with Metaphor Security, collaborating to secure the next generation of digital systems.
...
* 🏅 **GoCardless Bug Bounty Program – Security Researcher Hall of Fame @ HackerOne**  
...
* 🏆 **Syfe Security Researcher Hall of Fame**  
  https://www.syfe.com/bug-bounty#hall-of-fame-section
...
* 🏅 **Crunch.co.uk Security Researcher Hall of Fame**  
  https://help.crunch.co.uk/s/article/Responsible-Disclosure
